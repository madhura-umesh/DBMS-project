...
INSERT INTO `Librarian` VALUES (1,'Tejas','Admin','1234','Tejas.abhi08@gmail.com'),(2,'Achyut','Askadmin','9876','Askachyut@gmail.com');
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Publisher` (  `PublisherID` int(11) NOT NULL AUTO_INCREMENT,  `PublisherName` varchar(30) DEFAULT NULL,  PRIMARY KEY (`PublisherID`)) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Publisher` VALUES (1,'Pearson'),(2,'Sunstar'),(3,'dsd'),(4,'Whittaker'),(5,'Mcmillian'),(6,'Navakarnataka'),(7,'Boostmedia'),(8,'AvenueBookCentre'),(9,'IndiaToday'),(10,'HimalayaPublishers'),(11,'Water'),(12,'ew'),(13,'ATCPress'),(14,'SGAJ'),(15,'WHOKNOW'),(16,'Doubleday'),(17,'IndiabookHouse '),(18,'McGraw'),(19,'Klett'),(20,'Pushpalata'),(21,'Cambridge'),(22,'TMH');
...
INSERT INTO `Users` VALUES (1,'1234','2012-05-15','Mithun','mitbusiness15@gmail.com'),(2,'12345678','2016-11-07','Piyush','pkalkute@gmail.com'),(3,'012345','2016-11-25','Eshwar','Eshwarniki@gmail.com');
